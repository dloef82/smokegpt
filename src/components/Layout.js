...
const teams = [
  { id: 1, name: 'Dokumentarkiv', href: '#', initial: 'H', current: false },
  { id: 2, name: 'Produktionskalkyl', href: '#', initial: 'T', current: false },
  { id: 3, name: 'Övrigt', href: '#', initial: 'W', current: false },
]
                  ...
                  <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-gray-900 px-6 pb-4 ring-1 ring-white/10">
                    ...
                    <nav className="flex flex-1 flex-col">
                      <ul role="list" className="flex flex-1 flex-col gap-y-7">
                        ...
                        <li>
                          <div className="text-xs font-semibold leading-6 text-gray-400">Övriga länkar</div>
            ...
            <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
              <form className="relative flex flex-1" action="#" method="GET">
                ...
                <input
                  ...
                  placeholder="Sök i Smokehouse Admin..."
                  type="search"
                  name="search"
                />
              </form>
